/**
 * `@dynamicagents/core/job` — a long job a Durable Object owns through its
 * alarm, such as the workspace object's dependency install.
 *
 ...
 * for a plain `DurableObject` rather than an agent — which is why they are
